...
public String getTextMensajeErrorIncorrecto() {
    ...
    private void jTextFieldEmailKeyReleased(java.awt.event.KeyEvent evt) {                                            
        String textoEmail = jTextFieldEmail.getText();
        
        if (textoEmail.length() > 1) {
            jLabel2.setVisible(false);
        }
        
        if (emailValidator(textoEmail)) {
            cambiarColorTexto(colorMensajeCorrecto, textMensajeCorrecto, colorBordeCorrecto, fuenteMensajeError);
        } else {
            cambiarColorTexto(colorMensajeIncorrecto, textMensajeIncorrecto, colorBordeIncorrecto, fuenteMensajeError);
    ...
    public void cambiarColorTexto(Color color, String textMensaje, Color colorBorde, Font fuenteMensajeError) {
